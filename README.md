...
skills/
├── grace-ask/ # Ответ на вопрос о проекте с полным контекстом
├── grace-cli/ # Работа через командную строку
├── grace-execute/ # Выполнение действий
├── grace-explainer/ # Объяснение кода или архитектуры
├── grace-fix/ # Исправление ошибок
├── grace-init/ # Инициализация проекта или модуля
├── grace-multiagent-execute/ # Выполнение в мультиагентной среде
├── grace-plan/ # Планирование задач и этапов
├── grace-refactor/ # Рефакторинг кода
└── grace-refresh/ # Обновление контекста или артефактов
...
Пример для `grace-ask`:
```bash
cd skills/grace-ask
# Ознакомьтесь с SKILL.md
# Запустите навык с нужными параметрами (описание в SKILL.md)
...
Вот пошаговый план, как использовать эти навыки в правильном порядке.
🗺️ Общий рабочий процесс (Pipeline)
